...
from libs.dpg_addons.dpg_callback import dpg_callback
from libs.dpg_animations import StyleAnimation, StyleColorAnimation
from libs.dpg_animations.animator.value import FloatValueAnimation
from .themes import THEME

if TYPE_CHECKING:
    from libs.dpg_animations.loop import AnimatorType
...
def add_theme_picker(tag, width) -> int:
    dpg_object = dpg.add_combo(items=get_theme_names(), default_value=get_current_theme_name(), tag=tag, width=width,
